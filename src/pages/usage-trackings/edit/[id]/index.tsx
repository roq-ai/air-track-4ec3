      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'usage_hours',
              isInvalid: !!formik.errors?.usage_hours,
            }}
            name="usage_hours"
            error={formik.errors?.usage_hours}
            value={formik.values?.usage_hours}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('usage_hours', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
